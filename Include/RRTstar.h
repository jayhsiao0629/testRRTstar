...
public:
    ...
    std::chrono::duration<double> findNearest_time;
    std::chrono::duration<double> findNearNeighbors_time;
    std::chrono::duration<double> findParent_time;
   ...
   */
    std::vector<Point> planner(Graph &g);
   ...
   */
    ...
    */
    ...
    /**
     * @brief Get the number of Nodes in this RRT star
     * @param void
     * @return size_t
     */
    size_t GetNumNodes() { return this->nodes.size(); }
